...
export const transcribeChunkSchema = z
  .object({
    text: z.string(),
...
export type TranscribeChunkFromSchema = z.infer<typeof transcribeChunkSchema>;
...
export const transcribeResponseSchema = z.object({
  ...
  model_used: z.string(),
  chunks: z.array(transcribeChunkSchema).nullish(),
});
